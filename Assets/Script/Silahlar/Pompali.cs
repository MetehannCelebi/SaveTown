...
public class Pompali : MonoBehaviour
{
    ...
    void AtesEtmeTeknikİslemleri(bool yakinlasmavarmi)
    {
        ...
        Instantiate(Mermi, Mermi_Cikis_noktasi[0].transform.position, Mermi_Cikis_noktasi[0].transform.rotation);
        Instantiate(Mermi, Mermi_Cikis_noktasi[1].transform.position, Mermi_Cikis_noktasi[1].transform.rotation);
